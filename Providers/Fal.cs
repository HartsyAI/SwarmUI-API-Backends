...
public sealed class FalProvider : IProviderSource
{
    ...
    private static IEnumerable<ModelDefinition> SeedanceVideoModels =>
    [
        // === Seedance 2.0 ===
        ModelDefinitionBuilder.Create()
            .WithId("ByteDance/seedance-2.0-t2v")
            .WithEndpointOverride("bytedance/seedance-2.0/text-to-video")
            .WithTitle("Seedance 2.0 (T2V)")
            .WithDescription("ByteDance's top-ranked video model with native audio, multi-shot editing, and director-level camera control")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-2.0-t2v.jpg")
            .WithDate("2026")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("bytedance/seedance-2.0/fast/text-to-video")
            .WithTitle("Seedance 2.0 Fast (T2V)")
            .WithDescription("Faster, lower-cost variant of Seedance 2.0 text-to-video with native audio")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-2.0-fast-t2v.jpg")
            .WithDate("2026")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("bytedance/seedance-2.0/image-to-video")
            .WithTitle("Seedance 2.0 (I2V)")
            .WithDescription("Animate images into cinematic video with synchronized audio and start/end frame control")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-2.0-i2v.jpg")
            .WithDate("2026")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("bytedance/seedance-2.0/fast/image-to-video")
            .WithTitle("Seedance 2.0 Fast (I2V)")
            .WithDescription("Faster, lower-cost variant of Seedance 2.0 image-to-video with native audio")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-2.0-fast-i2v.jpg")
            .WithDate("2026")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("bytedance/seedance-2.0/reference-to-video")
            .WithTitle("Seedance 2.0 (Ref2V)")
            .WithDescription("Generate video from up to 9 images, 3 videos, and 3 audio clips as references")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-2.0-ref2v.jpg")
            .WithDate("2026")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("bytedance/seedance-2.0/fast/reference-to-video")
            .WithTitle("Seedance 2.0 Fast (Ref2V)")
            .WithDescription("Faster, lower-cost variant of Seedance 2.0 multi-reference video generation")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-2.0-fast-ref2v.jpg")
            .WithDate("2026")
        ...
        // === Seedance 1.0 ===
        ModelDefinitionBuilder.Create()
            .WithId("ByteDance/seedance-1.0-pro-t2v")
            .WithEndpointOverride("fal-ai/bytedance/seedance/v1/pro/text-to-video")
            .WithTitle("Seedance 1.0 Pro (T2V)")
            .WithDescription("ByteDance's Seedance 1.0 Pro text-to-video at up to 1080p resolution")
            .WithAuthor("ByteDance")
            .WithDimensions(1920, 1080)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-1.0-pro-t2v.jpg")
            .WithDate("2025")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("fal-ai/bytedance/seedance/v1/lite/text-to-video")
            .WithTitle("Seedance 1.0 Lite (T2V)")
            .WithDescription("Cost-effective Seedance 1.0 text-to-video at up to 720p resolution")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-1.0-lite-t2v.jpg")
            .WithDate("2025")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("fal-ai/bytedance/seedance/v1/pro/image-to-video")
            .WithTitle("Seedance 1.0 Pro (I2V)")
            .WithDescription("ByteDance's Seedance 1.0 Pro image-to-video at up to 1080p resolution")
            .WithAuthor("ByteDance")
            .WithDimensions(1920, 1080)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-1.0-pro-i2v.jpg")
            .WithDate("2025")
        ...
        ModelDefinitionBuilder.Create()
            ...
            .WithEndpointOverride("fal-ai/bytedance/seedance/v1/lite/image-to-video")
            .WithTitle("Seedance 1.0 Lite (I2V)")
            .WithDescription("Cost-effective Seedance 1.0 image-to-video at up to 720p resolution")
            .WithAuthor("ByteDance")
            .WithDimensions(1280, 720)
            .WithPreviewImage("Images/ModelPreviews/Fal/ByteDance/seedance-1.0-lite-i2v.jpg")
            .WithDate("2025")
