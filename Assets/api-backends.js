...
featureSetChangers.push(() => {
    ...
    if (!isApiModel) {
        return [[], ['openai_api', 'ideogram_api', 'bfl_api',
            ...
            'flux_ultra_params', 'flux_pro_params', 'flux_dev_params', 'flux_kontext_pro_params']];
    }
    ...
    if (isOpenAIModel) {
        ...
        addFlags.push('flux_ultra_params', 'flux_pro_params', 'flux_dev_params', 'flux_kontext_pro_params');
    }
